    ...
    return (
        <div className='flex flex-col-reverse md:flex-row items-center justify-between my-12 md:my-20'>
            <div className='space-y-4'>
                ...
                <Link className='btn text-[16px] border-1 border-[#7F3D27] text-[#D9D9D9] bg-[#7F3D27] transition-all hover:text-[#7F3D27] hover:bg-[#D9D9D9]'>Get Started <FaArrowRight /></Link>
            </div>
            <div>
